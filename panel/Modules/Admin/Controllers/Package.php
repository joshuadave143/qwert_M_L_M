...
class Package extends \Modules\Common\Controllers\AdminBaseController
{
	use ResponseTrait;
    public $parser;
    ...
    public function index(){
        ...
        $side['side_bar'] = $this->load_sidebar(array('item_index' => 2, 'sub_index' => 0, 'page_title' => 'Dashboard', 'show_page_title' => 1, 'show_breadcrumbs' => 1, 'user_type' => $this->joshua_auth->get_session_data('user_type')));
