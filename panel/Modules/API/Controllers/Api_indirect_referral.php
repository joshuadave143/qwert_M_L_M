...
class Api_indirect_referral extends ResourceController
{
    ...
    public function index(){
        ...
        $product         = $this->model
                                        ->from('vw_members vm')
                                        ->where('vm.node_id = tbl_indreferral_bonus.downline_id')
                                        ->where('tbl_indreferral_bonus.node_id',$this->session->get('node_id'))
                                        ->where('inreferral_status = 0')
                                        ->find();
        ...
        $json = $json_format->json_format($product,['downline_id','fullname','amount','inreferral_status']);   
