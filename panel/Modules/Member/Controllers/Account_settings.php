...
class Account_settings extends \Modules\Common\Controllers\MemberBaseController
{
use ResponseTrait;
public $parser;
public $success;
...
public function index(){
    ...
    array_push($this->data['js_entries'],
        ...
        array('js_link' => base_url().'/assets/plugins/bootstrap-editable/inputs-ext/address/address.js'),
        array('js_link' => base_url().'/assets/scripts/account_settings.js')
    );
    ...
    $this->data['page']         = 'Modules\Member\Views\account_settings';
    $this->data['css_custom']   = "";
    $this->data['js_custom']    = "";
    $this->data['message']      = "";
    $this->data['has_error']      = "";
    
    $side['side_bar'] = $this->load_sidebar(array('item_index' => 12, 'sub_index' => 0, 'page_title' => 'Dashboard', 'show_page_title' => 1, 'show_breadcrumbs' => 1, 'user_type' => $this->joshua_auth->get_session_data('user_type')));
