...
class Activation_code extends \Modules\Common\Controllers\AdminBaseController
{
    ...
    public function index(){
        ...
        $side['side_bar'] = $this->load_sidebar(array('item_index' => 4, 'sub_index' => 1, 'page_title' => 'Dashboard', 'show_page_title' => 1, 'show_breadcrumbs' => 1, 'user_type' => $this->joshua_auth->get_session_data('user_type')));
